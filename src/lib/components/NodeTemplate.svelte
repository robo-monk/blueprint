<script lang="ts">
    import { newNodeFromTemplate, type INode, type INodeTemplate } from "$lib/interfaces/types";
    import * as icons from "carbon-icons-svelte";
    import { get, writable, type Writable } from "svelte/store";
    import Node from "./Node.svelte";
    // export let node: Writable<INode>;
    export let nodeTemplate: INodeTemplate;
...
<Node node={newNodeFromTemplate(nodeTemplate)}/>